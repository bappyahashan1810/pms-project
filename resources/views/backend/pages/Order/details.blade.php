...
<div class="card">
  <div class="card-body">
    ...
    <p><strong>Shipping Country:&nbsp;</strong>{{$order->user->profile->country}}</p>
    <p><strong>Shipping City:&nbsp;</strong>{{$order->user->profile->city}}</p>
    <p><strong>Shipping Postcode:&nbsp;</strong>{{$order->user->profile->postcode}}</p>
